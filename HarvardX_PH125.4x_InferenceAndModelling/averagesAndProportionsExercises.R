# Averages and Proportions Exercises
...
#    the sum of your winnings after betting on green a number of times in
#    American Roulette.
#
# What is the probability that you end up winning money if you bet on green
#    100 times?
#
# INSTRUCTIONS
# Execute the sample code to determine the expected value avg and standard error
#    se as you have done in previous exercises.
...
# Create a Monte Carlo simulation that generates 10,000 outcomes of S, the sum
#    of 100 bets.
#
# Compute the average and standard deviation of the resulting list and compare
#    them to the expected value (-5.263158) and standard error (40.19344) for S
#    that you calculated previously.
#
# INSTRUCTIONS
# Use the replicate function to replicate the sample code for
#    B <- 10000 simulations.
# Use the sample function to simulate outcomes of either
#    a loss ($-1) or a win ($17) for the bet.
...
# In this chapter, you calculated the probability of winning money in American
#    roulette using the CLT.
#
# Now, calculate the probability of winning money from the Monte Carlo simulation.
#    The Monte Carlo simulation from the previous exercise has already been
#    pre-run for you, resulting in the variable S that contains a list of 10,000
#    simulated outcomes.
#
# INSTRUCTIONS
...
# The Monte Carlo result and the CLT approximation for the probability of losing
...
# Now create a random variable Y that contains your average winnings per bet
#    after betting on green 10,000 times.
#
# INSTRUCTIONS
# Use set.seed to make sure the result of your random operation matches the
#    expected answer for this problem.
# Specify the number of times you want to sample from the possible outcomes.
# Use the sample function to return a value from a vector of possible values:
#    winning $17 or losing $1.
...
#
# INSTRUCTIONS
# Using the chances of winning $17 (p_green) and the chances of
#    losing $1 (p_not_green), calculate the expected outcome of a bet that the
#    ball will land in a green pocket.
...
# Given this average and standard error, determine the probability of winning
#    more than $0. Print the result to the console.
...
# In a previous exercise, you found the probability of winning more than $0
#    after betting on green 10,000 times using the Central Limit Theorem. Then,
#    you used a Monte Carlo simulation to model the average result of betting on
#    green 10,000 times over 10,000 simulated series of bets.
#
# What is the probability of winning more than $0 as estimated by your Monte
#     Carlo simulation? The code to generate the vector S that contains the
#     average outcomes of 10,000 bets modeled 10,000 times has already been run
#     for you.
#
# INSTRUCTIONS
